...
class PoolRebalancingIntegrationTest extends AbstractIntegrationTest {
    ...
    void usdBelowFloor_fullRecovery_whenShortageIsLessThanKrwSurplus() {
        ...
        companyPoolService.depositForRemittance("case3-recv", "KRW", new BigDecimal("651950000"), "3-recv");
        companyPoolService.withdrawForRemittance("case3-pay", "USD", new BigDecimal("500000"), "3-pay");
    ...
    void usdBelowFloor_partialRecovery_cappedByKrwFloor_bothStillNormal() {
        ...
        companyPoolService.depositForRemittance("case4-recv", "KRW", new BigDecimal("1955850000"), "4-recv");
        companyPoolService.withdrawForRemittance("case4-pay", "USD", new BigDecimal("1500000"), "4-pay");
